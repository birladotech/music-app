let coverTioby = `https://amplify-bermuse-staging-123136-deployment.s3.amazonaws.com/tiobydsb/cover/%232+COVER+TIOBY+ALBUM+final.PNG`;
let tioby = "Tioby Dsb";
const audioList = [
  {
    id: 1,
    ...
    cover: coverTioby,
    musicSrc:
      "https://amplify-bermuse-staging-123136-deployment.s3.amazonaws.com/tiobydsb/01-Intro.flac",
  ...
  },
  {
    ...
    cover: coverTioby,
    musicSrc:
      "https://amplify-bermuse-staging-123136-deployment.s3.amazonaws.com/tiobydsb/02-Lifestyle.mp3",
  },
  {
    id: 3,
    name: "03. LI PA SA VRE ",
    singer: tioby,
    cover: coverTioby,
    musicSrc:
      "https://amplify-bermuse-staging-123136-deployment.s3.amazonaws.com/tiobydsb/03-Li+Pa+Sa+Vre.mp3",
  },
  {
    id: 4,
    name: "04. NOU LOU (FT JAY BALLIN & CAMP HOMIE)",
    singer: tioby,
    cover: coverTioby,
    musicSrc:
      "https://amplify-bermuse-staging-123136-deployment.s3.amazonaws.com/tiobydsb/04-Nou+Lou+(Ft+Jay+Balinn+%26+Camp+Homie).mp3",
  },
  {
    id: 5,
    name: "05. TRUE LOVE ",
    ...
    cover: coverTioby,
    musicSrc:
      "https://amplify-bermuse-staging-123136-deployment.s3.amazonaws.com/tiobydsb/05-True+Love.mp3",
  },
  {
    id: 6,
    name: "06. BAD GAME ",
    ...
    cover: coverTioby,
    musicSrc:
      "https://amplify-bermuse-staging-123136-deployment.s3.amazonaws.com/tiobydsb/06-Bad+Game.mp3",
  },
  {
    id: 7,
    name: "07. MY WAY ",
    ...
    cover: coverTioby,
    musicSrc:
      "https://amplify-bermuse-staging-123136-deployment.s3.amazonaws.com/tiobydsb/07-My+Way.mp3",
  },
  {
    id: 8,
    name: "08.OU SE VIM FT DJOUBY",
    singer: tioby,
    cover: coverTioby,
    musicSrc:
      "https://amplify-bermuse-staging-123136-deployment.s3.amazonaws.com/tiobydsb/08-Ou+se+vim+ft+Djouby.mp3",
  },
  {
    id: 9,
    name: "09. MOVE",
    ...
    cover: coverTioby,
    musicSrc:
      "https://amplify-bermuse-staging-123136-deployment.s3.amazonaws.com/tiobydsb/09-Move.mp3",
  },
  {
    id: 10,
    name: "10. I NEED U",
    ...
    cover: coverTioby,
    musicSrc:
      "https://amplify-bermuse-staging-123136-deployment.s3.amazonaws.com/tiobydsb/10-TIOBY+DSB+-+I+NEED+U.mp3",
  },
  {
    id: 11,
    name: "11. Freestyle(Track Bonus)",
    singer: tioby,
    cover: coverTioby,
    musicSrc:
      "https://amplify-bermuse-staging-123136-deployment.s3.amazonaws.com/tiobydsb/11-Freestyle+(Bonus).flac",
  },
];
